    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card register-page">
                <div class="card-header text-white card_header">{{ __('Registracija') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Patvirtinkite slaptažodį') }}</label>
